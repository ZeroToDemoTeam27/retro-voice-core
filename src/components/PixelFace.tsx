...
export const PixelFace = ({
  ...
  const renderEyes = () => {
    ...
    switch (emotion) {
      case 'NEUTRAL':
        return <>
            <motion.rect x="80" y="80" width="40" height={blink ? "2" : "40"} fill="hsl(var(--primary))" transition={baseTransition} />
            <motion.rect x="180" y="80" width="40" height={blink ? "2" : "40"} fill="hsl(var(--primary))" transition={baseTransition} />
          </>;
      case 'HAPPY':
        return <motion.g animate={{
          ...
          ease: "easeInOut"
            ...
            <motion.path d="M 80 100 L 100 80 L 120 100 Z" fill="hsl(var(--primary))" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={baseTransition} />
            <motion.path d="M 180 100 L 200 80 L 220 100 Z" fill="hsl(var(--primary))" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={baseTransition} />
      ...
      case 'SAD':
        return <>
            <motion.rect x="80" y="90" width="40" height="60" fill="hsl(var(--primary))" animate={{
            height: [60, 55, 60]
          }} transition={{
            duration: 3,
            repeat: Infinity,
            ...
            <motion.rect x="180" y="90" width="40" height="60" fill="hsl(var(--primary))" animate={{
            height: [60, 55, 60]
          }} transition={{
            duration: 3,
            repeat: Infinity,
  ...
  const renderMouth = () => {
    ...
    switch (emotion) {
      case 'NEUTRAL':
        return <motion.line x1="120" y1="200" x2="180" y2="200" stroke="hsl(var(--primary))" strokeWidth="4" transition={baseTransition} />;
      case 'HAPPY':
        return <motion.path d="M 100 190 Q 150 220 200 190" stroke="hsl(var(--primary))" strokeWidth="4" fill="none" animate={{
          d: ["M 100 190 Q 150 220 200 190", "M 100 190 Q 150 225 200 190", "M 100 190 Q 150 220 200 190"]
        }} transition={{
          duration: 2.5,
          repeat: Infinity,
          ease: "easeInOut"
      ...
      case 'CONFUSED':
        return <motion.path d="M 100 200 L 130 190 L 160 200 L 190 195" stroke="hsl(var(--primary))" strokeWidth="4" fill="none" animate={{
          x: [-3, 3, -3]
        }} transition={{
          duration: 2.5,
          repeat: Infinity,
